...
const authSecurity = require('@/lib/auth-security') as typeof import('@/lib/auth-security')
const {
...
const { securityMonitor } = require('@/lib/security-monitor') as typeof import('@/lib/security-monitor')
